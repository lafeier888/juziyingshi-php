...
define('REFERER_URL', ''); //如：define('REFERER_URL', 'www.176yun.com|api.176yun.com|https:\/\/api.176yun.com');
...
$user = array(
		...
		'uid' => '191648491015', //这里填写你的UID信息,用户授权UID，在 https://service.pangujiexi.com/ 平台可以查看到

		'token' => '7968B0DFF66EF06A0446DF4055A145AD', //这里填写你的TOKEN信息,用户授权TOKEN，在 https://service.pangujiexi.com/ 平台可以查看到

		'path' => '/pangu', //一般不用修改,除非你修改了pangu目录名
		...
		'cdncache' => '1', //是否启用用户访问本地客户端JS文件,将会消耗您服务器宽带,同时弹幕会关闭,默认启用,1:启用,0:关闭

		'localdanma' => '0', //dplayer弹幕是否启用公共弹幕,当弹幕功能开启后才生效,关闭后将会只你网站上弹幕才可见,默认关闭,1:开启,0:关闭,

		'danmaku' => '1', //dplayer弹幕功能,默认开启,1:开启,0:关闭;

		'online' => '0', //当前无法解析的地址是否跳转至官网观看,默认开启,1:开启,0:关闭
		...
		'title' => '聚合影视', //用户设置解析页面title名称   //填写实例：'title' => '聚合影视',
