<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"/opt/lampp/htdocs/application/index/view/admin/sysconfig.html";i:1545548326;s:52:"/opt/lampp/htdocs/application/index/view/layout.html";i:1558683364;}*/ ?>
<!doctype html>
<html>
...
<div class="panel panel-default">
        ...
        <form role="form" id="form1" method="post" action="<?php echo url('admin/sysconfig'); ?>" class="validate">

			<div class="form-group" >
                <label class="control-labell" for="field-5" style="color:#fb0cb5">app名称</label>
				<br>
                <input class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['app_name']['content']; ?>" name="app_name" >
            </div>     
    	 ...
    	 <div class="form-group">
                <label >APP首页公告</label>
				<br>
                <textarea class="form-control" name="app_index_ad" cols="5" id="field-5" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 50px;"><?php echo $data['app_index_ad']['content']; ?></textarea>
                </div>
                ...
                <textarea class="form-control" name="proxy_ad" cols="5" id="field-5" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 50px;"><?php echo $data['proxy_ad']['content']; ?></textarea>
              </div>
	        <br>	<br>
			<div class="form-group" >
                <label class="control-labell" for="field-5">积分兑换（X积分兑换一天使用时间）</label>
				<br>
                <input class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['scoreExchange']['content']; ?>" name="scoreExchange" >
            </div>

				<div class="form-group">
                <label class="control-labell" for="field-5" >试用时间（请填写分钟）</label>
				<br>
                <input type='number' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['trialTime']['content']; ?>" name="trialTime" >
            </div>
          	...
          	<br>	<br>
                ...
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_1']['content']; ?>" name="resolveInterface_1" >
            </div>
			<br>
			<div class="form-group">
                <label class="control-labell" for="field-5">解析接口地址2</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_2']['content']; ?>" name="resolveInterface_2" >
            </div>
			<br>
			<div class="form-group">
                <label class="control-labell" for="field-5">解析接口地址3</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_3']['content']; ?>" name="resolveInterface_3" >
            </div>
			<br>
			<div class="form-group">
                <label class="control-labell" for="field-5">解析接口地址4</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_4']['content']; ?>" name="resolveInterface_4" >
            </div>
			<br>
			<div class="form-group">
                <label class="control-labell" for="field-5">解析接口地址5</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_5']['content']; ?>" name="resolveInterface_5" >
            </div>
			...
			<div class="form-group">
                ...
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_6']['content']; ?>" name="resolveInterface_6" >
            </div>
          
			<br>
			<div class="form-group">
                <label class="control-labell" for="field-5">解析接口地址7</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_7']['content']; ?>" name="resolveInterface_7" >
            </div>
          
			<br>
			<div class="form-group">
                <label class="control-labell" for="field-5">解析接口地址8</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_8']['content']; ?>" name="resolveInterface_8" >
            </div>
          
			<br>
			<div class="form-group">
                <label class="control-labell" for="field-5">解析接口地址9</label>
                <input type='text' class="form-control" style="margin: 0px -33.5px 0px 0px; width: 650px; height: 30px;" value="<?php echo $data['resolveInterface_9']['content']; ?>" name="resolveInterface_9" >
            </div>          
