<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"/opt/lampp/htdocs/application/index/view/admin/appconfig.html";i:1545545160;s:52:"/opt/lampp/htdocs/application/index/view/layout.html";i:1558683364;}*/ ?>
<!doctype html>
<html>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form role="form" id="form1" method="post" action="<?php echo url('admin/appconfig'); ?>" class="validate">



			<div class="form-group">
                <label class="control-label">客服微信(会显示在属于你用户的APP中)</label>

                <input type="text" class="form-control" id="weichat" name="weichat" value="<?php echo $data['weichat']['content']; ?>"  placeholder="微信" />
            </div>
          <!--
			  <div class="form-group">
          ...
          -->
			  ...
			  <div class="form-group">
                <label class="control-label">七天购买链接(如不填写，会默认弹出联系方式)</label>

                <input type="text" class="form-control"  name="day_7" value="<?php echo $data['day_7']['content']; ?>"  placeholder="七天购买链接,请以http://开头" />
            </div>          
          
          
			  <div class="form-group">
                <label class="control-label">一个月购买链接(如不填写，会默认弹出联系方式)</label>
                <input type="text" class="form-control"  name="month_1" value="<?php echo $data['month_1']['content']; ?>"  placeholder="一个月购买链接,请以http://开头" />
            </div>
			  <div class="form-group">
                <label class="control-label">三个月购买链接(如不填写，会默认弹出联系方式)</label>

                <input type="text" class="form-control"  name="month_3" value="<?php echo $data['month_3']['content']; ?>"  placeholder="三个月购买链接,请以http://开头" />
            </div>
            
			  <div class="form-group">
                <label class="control-label">六个月购买链接(如不填写，会默认弹出联系方式)</label>

                <input type="text" class="form-control"  name="month_6" value="<?php echo $data['month_6']['content']; ?>"  placeholder="六个月购买链接,请以http://开头" />
            </div>                 
          
			  <div class="form-group">
                <label class="control-label">一年购买链接(如不填写，会默认弹出联系方式)</label>

                <input type="text" class="form-control" name="year_1" value="<?php echo $data['year_1']['content']; ?>"  placeholder="一年购买链接,请以http://开头" />
            </div>
			  <div class="form-group">
                <label class="control-label">永久购买链接(如不填写，会默认弹出联系方式)</label>

                <input type="text" class="form-control"  name="year_all" value="<?php echo $data['year_all']['content']; ?>"  placeholder="永久购买链接,请以http://开头" />
            </div>
